                        ...
                        <div class="body table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="listService" items="${pagedListService.pageList}">

                                        <!-- construct an "delete" link with customer id -->
                                        <c:url var="deleteLink" value="/admin/deleteService">
                                            <c:param name="serviceId" value="${listService.serviceId}" />
                                        </c:url>
                                        ...
                                        <tr>
                                            <td>${listService.serviceName}</td>
                                            <td>${listService.description}</td>
                                            <td>${listService.unit}</td>
