                ...
                <div class="content">                   
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Form Add Service</div>
                        </div>                       
                        <form:form class="form-horizontal" action="addService" method="POST" modelAttribute="charge">
                            <div class="card-body">
                                <form:hidden path="chargeId" />
                                <div class="form-group">
                                    <label for="largeInput">Room Number</label>
                                    <form:input path="room.roomnumber" class="form-control form-control-lg" id="largeInput" placeholder=""/>
                                    <form:errors path="room.roomnumber" cssClass="error" />
                                </div>

                                <div class="form-group">
                                    <label for="smallInput">Quantity</label>
                                    <form:input path="quantity" class="form-control form-control-sm" id="smallInput" placeholder="Small Input"/>
                                    <form:errors path="quantity" cssClass="error" />
                                </div>
                                <div class="form-group">
                                    <label for="defaultSelect">Service</label>
                                    <form:select path="service.serviceName" class="form-control form-control" id="defaultSelect">
                                        <c:forEach var="pagedListServiceName" items="${pagedListService.pageList}">

                                            <form:option value="${pagedListServiceName.serviceName}"></form:option>
