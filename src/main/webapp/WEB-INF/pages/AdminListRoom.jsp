                ...
                <div class="content">                   
                    <div class="card">
                        <div class="header">
                            ...
                            <a href="<c:url value="/admin/Listroomtype" />" class="btn btn-success waves-effect">List Room Type</a>
                        </div>
                        ...
                        <div class="body table-responsive">
                            <table class="table table-bordered table-striped">
                                <thead class="btn-success">   
                                    <tr>
                                        <th style="width: 2%">Room Number</th>
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="listRoom" items="${pagedListRoom.pageList}">

                                        <!-- construct an "delete" link with customer id -->
                                        <c:url var="deleteLink" value="/admin/deleteRoom">
                                            <c:param name="roomid" value="${listRoom.roomid}" />
                                        </c:url>
                                        <!-- construct an "update" link with customer id -->
                                        <c:url var="updateLink" value="/admin/updateRoom">
                                            <c:param name="roomid" value="${listRoom.roomid}" />
                                        </c:url>


                                        <tr>
                                            <td>${listRoom.roomnumber}</td>
                                            <td>${listRoom.roomtype.typename}</td>
                                            <td>${listRoom.roomtype.description}</td>
                                            <td>${listRoom.roomtype.numberofpeopke}</td>                                           
                                            <td>${listRoom.floor}</td>
                                            <td>${listRoom.price}$</td>
                                            <td><img src="../resources/images/${listRoom.roomtype.image}" width="240" height="120"/></td>
